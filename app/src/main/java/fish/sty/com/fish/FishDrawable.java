...
public class FishDrawable extends Drawable {
    ...
    protected static final float BODY_LENGTH = HEAD_RADIUS * 3.2f;
    ...
    private void init(){
        ...
        middlePoint = new PointF(4.18f * HEAD_RADIUS, 4.18f * HEAD_RADIUS); //控件最小尺寸为8.36R
    ...
    public void draw(Canvas canvas) {
        //生成一个半透明图层，否则域背景白色形成干扰，尺寸必须与view的大小一致，否则鱼显示不全
    ...
    private void makeBody(Canvas canvas, float headRadius){
        ...
        PointF endPoint = calculatPoint(headPoint, BODY_LENGTH, angle - 180);
        //躯干2
        ...
        //决定胖瘦
        contralLeft = calculatPoint(headPoint, BODY_LENGTH * 0.56f, angle - 130);
        contralRight = calculatPoint(headPoint, BODY_LENGTH * 0.56f, angle + 130);
        mPath.reset();
    ...
    private void makeSegments(Canvas canvas, PointF mainPoint, float segmentRadius, float MP, float fatherAngle){
        ...
        PointF endPoint = calculatPoint(mainPoint, segmentLength, angle - 180);
    ...
    private void makeSegmentsLong(Canvas canvas, PointF mainPoint, float segmentRadius, float MP, float fatherAngle){
        ...
        point1 = calculatPoint(mainPoint, segmentRadius, angle - 90);
        point2 = calculatPoint(endPoint, segmentRadius * MP, angle - 90);
        point3 = calculatPoint(endPoint, segmentRadius, angle + 90);
        point4 = calculatPoint(mainPoint, segmentRadius, angle + 90);
    ...
    private void makeFins(Canvas canvas, PointF startPoint, int type, float fatherAngle){
        ...
        PointF endPoint = calculatPoint(startPoint, FINS_LENGTH, type == FINS_RIGHT ?
                fatherAngle - finsAngle - 180 : fatherAngle + finsAngle + 180);
    ...
    /**
     * 高度要容得下两个鱼身的长度
     * 8.38 计算过程：(身长6.79 - 头顶到中部位置的长度2.6) * 2
     */
    @Override
